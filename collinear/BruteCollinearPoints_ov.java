...
public class BruteCollinearPoints_ov {
    private LineSegment[] segments; // record segments
    private int n;    // record number of segments

    public BruteCollinearPoints_ov(Point[] pointSet) { // finds all line segments containing 4 points
    ...
    public static void main(String[] args) {
        ...
        BruteCollinearPoints_ov collinear = new BruteCollinearPoints_ov(points);
